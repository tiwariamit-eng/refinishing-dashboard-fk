...
function drawVertTable(sites,weeks){
  let h='<thead><tr><th>Site</th><th>Zone</th><th>Apparel</th><th>Footwear</th><th>App samples</th><th>Ftw samples</th><th>Gap (App−Ftw)</th></tr></thead><tbody>';
  sites.forEach(s=>{
    const z=D.zone_of[s]||'';
